...
| [`CloseAction`](src/main/java/dev/ivchenko/lwjwae/CloseAction.java)                                                                                                                                                                                                                                                       | What the close button of the title bar does: `CLOSE`, or `HIDE` for an application that lives in the tray. `Window.closeAction(...)` changes it at run time; `requestClose()` does what the button does, `close()` always closes.                                                                                                                      |
